...
public class FlipKart_Booking {
	...
	public void ticketBooking() throws InterruptedException {
		...
		Thread.sleep(2000);
		WebElement ele1 = d.findElement(By.xpath("//div[text()='April 2022']/ancestor::table//div[@class='_3hsbax']"));
		as.moveToElement(ele1).click().click().perform();
		Thread.sleep(2000);
//		d.findElement(By.xpath("//div[text()='February 2022']/../../../../..//button[text()='22']")).click();
		d.findElement(By.xpath("//div[text()='May 2022']/following::button[text()='22']")).click();
